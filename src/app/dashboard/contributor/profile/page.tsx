...
export default function ContributorProfilePage() {
    ...
    useEffect(() => {
        const fetchRank = async () => {
            ...
            const leaderboard = await getLeaderboardUsers(250);
    ...
    return (
        <div className="space-y-8">
            <PageHeader
                title="Profile"
                description="General account and participation details."
            />
                ...
                <CardContent className="space-y-6">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <p className="text-lg font-semibold">{userData.githubUsername || "Contributor"}</p>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="border border-surface-lighter p-4">
                            <p className="text-xs uppercase font-(family-name:--font-jetbrains) text-ink/60">Total Points</p>
                            <p className="text-lg font-bold">{userData.points || 0}</p>
                        </div>
                        <div className="border border-surface-lighter p-4">
                            <p className="text-xs uppercase font-(family-name:--font-jetbrains) text-ink/60">Leaderboard Rank</p>
                            <p className="text-lg font-bold">{leaderboardRank ? `#${leaderboardRank}` : "Unranked"}</p>
                        </div>
                        <div className="border border-surface-lighter p-4">

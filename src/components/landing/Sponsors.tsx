            ...
            .map((sponsor, idx) => {
              ...
              const content = (
                <div className="flex flex-col items-center gap-6">
                  <div
                    className={`h-48 w-80 border-2 ${styles.border} ${styles.hoverBorder} bg-surface-light rounded-none flex items-center justify-center ${styles.shadow} ${styles.hoverShadow} group-hover:-translate-y-2 transition-all duration-300 relative overflow-hidden`}
                  >
                    <div
                      className={`absolute inset-0 bg-linear-to-br ${styles.accentGradient} opacity-0 group-hover:opacity-100 transition-opacity`}
                    />
                  ...
                  <div
                    className={`flex items-center gap-2 ${styles.badgeBg} text-white px-6 py-2 font-bold uppercase tracking-wider text-xs shadow-[4px_4px_0_0_rgba(0,0,0,0.1)] rounded-none`}
                  >
          ...
          <div className="bg-surface-light border-2 border-ink/20 rounded-none p-8 sm:p-12 shadow-[8px_8px_0_0_rgba(0,0,0,0.1)] relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-ink/60 mb-8 max-w-md mx-auto font-(family-name:--font-jetbrains) text-sm leading-relaxed">
                Partner with us to empower the next generation of open-source
                developers.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button variant="brutalist" size="lg" className="group" asChild>
